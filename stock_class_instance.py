...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        ...
        funcDict = {
            'fetch_new_stock_index_all': stockInstance.fetch_new_stock_index_all,
        ...
        if str(sys.argv[1]) not in noMultiThread:
            if str(sys.argv[1])=='fetch_new_stock_index_all':
                stockInstance.fetch_new_stocks()
                stockCodes = stockInstance.getStockCodes(True)
                functionCall = stockInstance.retrieveStockData
            else:
            ...
            # stockCodes = ['00718B','00719B','00720B','00721B','00725B','00726B','00727B','00728','00729R','00730','00731','00732','00733','00734B','00735','00736','00737','00738U','00739','00740B','00741B','00742','01009T','17333','20067','22392','26095','26106','2881B','2891B','2942','3158','32722','34131','36252','36532','36892','36912','3711','45511','45551','45601','4572','47145','47352','47463','49273','49792','5223','54255','62742','64492','64511','64691','64721','6474','6616','6656','6672','6673','6677','6679','6680','6681','6682','6683','6684','6689','80272','80425','80764','81102','8298','84033','84362','84621','84761','89335']
            ...
            if str(sys.argv[1]) == 'fetch_new_stock_index_all':
                functionCall = stockInstance.computeStockKD
                threads = []
                ...
                print('\n\nFinish fetching new stocks. Start calculating stockK and stockD...\n\n')
                ...
                stockInstance.update_stocktable_new_to_old()
        else:
